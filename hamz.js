...
ham.sendMessage(m.chat, buttonMessage, {quoted:crotah})
}
break
case 'buggc': {
...
const btn = [
    ...
    {index: 2, quickReplyButton: { displayText: `ML`, id: 'emel'} },
	{index: 3, quickReplyButton: { displayText: `FF`, id: 'efef'} },
    {index: 4, quickReplyButton: { displayText: `Dll`, id: 'lainnya'} }
]
let butts = [
...
let buttonMessage = {
	image: { url: `https://i.ibb.co/rybgnW0/gege.png` },
	caption: `Mau Topup apa?`,
	//buttons: butts,
	templateButtons: btn,
...
const btn = [
    {index: 1, urlButton: {displayText: `OWNER`, url : 'https://wa.me/qr/M3ZKS3GNCSJSG1' }}]
ham.sendMessage(m.chat, { image: { url: `https://i.ibb.co/vQ4WPkz/gege.png` }, caption: `*NB: Harga Sewaktu-waktu akan berubah*
https://wa.me/qr/M3ZKS3GNCSJSG1`, templateButtons: btn},{quoted:m})
}
break
			case 'restart': {
